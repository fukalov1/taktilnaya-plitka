...
namespace App\Admin\Extensions\Dashboard;
...
class MyDashboard
{
    ...
    {
        $envs = [
            ['name' => 'Версия PHP',       'value' => 'PHP/'.PHP_VERSION],
            ['name' => 'Версия Laravel',   'value' => app()->version()],
            ['name' => 'CGI',               'value' => php_sapi_name()],
            ['name' => 'Параметры ОС',             'value' => php_uname()],
            ['name' => 'Сервер',            'value' => array_get($_SERVER, 'SERVER_SOFTWARE')],

            ['name' => 'Кэш драйвер',      'value' => config('cache.default')],
            ['name' => 'Драйвер сессии',    'value' => config('session.driver')],
            ['name' => 'Драйвер очереди',      'value' => config('queue.default')],

            ['name' => 'Временная зона',          'value' => config('app.timezone')],
            ['name' => 'Язык',            'value' => config('app.locale')],
